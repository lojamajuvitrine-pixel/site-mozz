...
// swipe.
// Altura reduzida em ~25% (pedido do Brunno em 09/09/2026) - era aspect-[4/5] no celular e
// aspect-[21/9] no desktop, ficou aspect-[16/15] e aspect-[28/9] (mesma largura, banner mais
// baixo).
export default function BannerHero({ banners }: { banners: BannerItem[] }) {
  ...
  return (
    <section
      className="relative -mx-6 aspect-[16/15] md:aspect-[28/9] bg-mozz-black overflow-hidden touch-pan-y"
